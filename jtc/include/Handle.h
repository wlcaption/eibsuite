...
class JTC_IMPORT_EXPORT JTCThread;
typedef JTCHandleT<JTCThread> JTCThreadHandle;

class JTC_IMPORT_EXPORT JTCThreadGroup;
typedef JTCHandleT<JTCThreadGroup> JTCThreadGroupHandle;

class JTC_IMPORT_EXPORT JTCRunnable;
...
public:
    ...
    //
    JTCHandleT<T>&
    operator=(const JTCHandleT<T>& rhs);
    ...
    //
    bool
    operator==(const JTCHandleT<T>& rhs) const
    {
