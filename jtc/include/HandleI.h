...
template <class T> JTCHandleT<T>::JTCHandleT(T* tg)
    : m_object(tg)
{
    if (m_object != 0)
    {
...
template <class T> JTCHandleT<T>::JTCHandleT(const JTCHandleT<T>& rhs)
...
template <class T> JTCHandleT<T>& JTCHandleT<T>::operator=(const JTCHandleT<T>& rhs)
{
...
template <class T> JTCHandleT<T>& JTCHandleT<T>::operator=(T* tg)
{
    if (m_object == tg)
	return *this;
