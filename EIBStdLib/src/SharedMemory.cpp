...
CSharedMemory::CWriteQueue::CWriteQueue(int nDataSize)
{
	pData = new BYTE[nDataSize];
	pNext = NULL;
}

CSharedMemory::CWriteQueue::~CWriteQueue()
{
	delete [] pData;
}
...
bool CSharedMemory::Open(char* sName, int nDataSize, int nTimeOut)
{
	m_pFirst	= NULL;
...
int CSharedMemory::Write(void *pData, int nDataSize, DWORD dwTimeOut)
{
...
int CSharedMemory::WriteToQueue(void *pData, int nDataSize)
{
	// The 'Write' and 'WriteToQueue' functions can be used promiscously.
...
int CSharedMemory::Read(void *pData, int nDataSize, DWORD dwTimeOut)
{
...
void CSharedMemory::EmptyWriteQueue()
{
...
void CSharedMemory::QueueThread(void *pArg)
{
