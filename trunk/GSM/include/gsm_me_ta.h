...
namespace gsmlib
{
  ...
  struct GSM_API_EXPORT Capabilities
  {
  ...
  // call forward info
  struct GSM_API_EXPORT ForwardInfo
  {
  ...
  class GSM_API_EXPORT MeTa : public RefBase
  {
  protected:
