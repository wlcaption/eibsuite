#ifndef __CONFIG_GSM_HEADER__
#define __CONFIG_GSM_HEADER__
...
#ifdef GSM_EXPORTS
#define GSM_API_EXPORT __declspec(dllexport)
#else
#define GSM_API_EXPORT __declspec(dllimport)
#endif

#ifndef GSM_API_EXPORT
extern template class GSM_API_EXPORT Ref<Port>
extern template class GSM_API_EXPORT Ref<GsmAt>
#endif

#else
#define GSM_API_EXPORT
#endif
