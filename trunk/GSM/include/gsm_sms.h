...
namespace gsmlib
{
  ...
  class GSM_API_EXPORT SMSMessage : public RefBase
  {
  private:
...
//     SMSMessage &operator=(SMSMessage &m);
  ...
  // SMS-DELIVER TPDU
  class GSM_API_EXPORT SMSDeliverMessage : public SMSMessage
  {
  private:
  ...
  // SMS-SUBMIT TPDU
  class GSM_API_EXPORT SMSSubmitMessage : public SMSMessage
  {
  private:
  ...
  class GSM_API_EXPORT SMSStatusReportMessage : public SMSMessage
  {
  private:
  ...
  // SMS-COMMAND TPDU
  class GSM_API_EXPORT SMSCommandMessage : public SMSMessage
  {
  public:
  ...
  class GSM_API_EXPORT SMSDeliverReportMessage : public SMSMessage
  {
  private:
  ...
  class GSM_API_EXPORT SMSSubmitReportMessage : public SMSMessage
  {
  private:
