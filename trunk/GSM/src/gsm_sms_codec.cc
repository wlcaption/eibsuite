...
Timestamp SMSDecoder::getTimestamp()
{
  ...
  result._year = (short)getSemiOctetsInteger(2);
  result._month = (short)getSemiOctetsInteger(2);
  result._day = (short)getSemiOctetsInteger(2);
  result._hour = (short)getSemiOctetsInteger(2);
  result._minute = (short)getSemiOctetsInteger(2);
  result._seconds = (short)getSemiOctetsInteger(2);
  result._timeZoneMinutes = (short)getTimeZone(result._negativeTimeZone);
  return result;
}
