...
class JTC_IMPORT_EXPORT JTCMonitorBase
{
protected:
...
protected:
    ...
    //
    void validate_owner(const JTCThreadId&, const char* caller) const;
...
private:
    ...
    //
    JTCMonitorBase(const JTCMonitorBase&);
    void
    operator=(const JTCMonitorBase&);
};
...
private:
    ...
    friend class JTCSyncT< JTCMonitorT< T > >;
...
class JTC_IMPORT_EXPORT JTCMonitor : public JTCMonitorBase
{
public:
