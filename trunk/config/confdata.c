...
const char conf_def_filename[] = DEFAULT_FILENAME;

const char conf_defname[] = DEFAULT_CONFIG;
...
int conf_write(const char *name)
{
	...
	if (out_h) {
		fclose(out_h);
		// ebi: remarked -- we are building on the fact the .tmpconfig.h is created
