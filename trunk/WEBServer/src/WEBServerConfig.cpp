...
CWEBServerConfig::CWEBServerConfig(void)
{
}
...
void CWEBServerConfig::Load(const CString& file_name)
{
	Init();
...
void CWEBServerConfig::SaveGeneralBlock(CConfigBlock& block)
{
	CConfParam pv;
	#define CONF_ENTRY(var_type, method_name, user_string, def_val) \
...
void CWEBServerConfig::LoadGeneralBlock(list<CConfParam>& params,const CString& file_name)
{
