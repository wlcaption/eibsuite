...
CAMXServerConfig::CAMXServerConfig(void)
{
}
...
void CAMXServerConfig::Load(const CString& file_name)
{
	Init();
...
void CAMXServerConfig::Save(const CString& file_name)
{
...
void CAMXServerConfig::SaveGeneralBlock(CConfigBlock& block)
{
	CConfParam pv;
	#define CONF_ENTRY(var_type, method_name, user_string, def_val) \
...
void CAMXServerConfig::LoadGeneralBlock(list<CConfParam>& params,const CString& file_name)
{
