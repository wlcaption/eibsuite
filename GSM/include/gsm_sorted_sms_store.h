...
namespace gsmlib
{
  ...
  class GSM_API_EXPORT SortedSMSStoreIterator : public SMSStoreMapIterator
  {
  public:
  ...
  class GSM_API_EXPORT SortedSMSStore : public RefBase, public NoCopy
  {
  private:
