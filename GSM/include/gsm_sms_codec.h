...
namespace gsmlib
{
  ...
  struct GSM_API_EXPORT Timestamp
  {
  ...
  struct GSM_API_EXPORT TimePeriod
  {
  ...
  class GSM_API_EXPORT DataCodingScheme
  {
  private:
    unsigned char _dcs;
  ...
  public:
    ...
    bool messageWaitingIndication() const
      {return (_dcs & DCS_MESSAGE_WAITING_INDICATION) == DCS_MESSAGE_WAITING_INDICATION;}
  ...
  class GSM_API_EXPORT UserDataHeader
  {
  private:
    string _udh;
