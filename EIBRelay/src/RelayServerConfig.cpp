...
CRelayServerConfig::CRelayServerConfig(void)
{
}
...
void CRelayServerConfig::Load(const CString& file_name)
{
	Init();
...
void CRelayServerConfig::SaveGeneralBlock(CConfigBlock& block)
{
	CConfParam pv;
	#define CONF_ENTRY(var_type, method_name, user_string, def_val) \
...
void CRelayServerConfig::LoadGeneralBlock(list<CConfParam>& params,const CString& file_name)
{
