namespace EIBConsole
{
    public static class ConsoleDefinitions
    {
        ...
        public static class EIBInterfaceConf
        {
            ...
            public const string EIB_INTERFACE_DEV_DESCRIPTION_XML = "EIB_INTERFACE_DEV_DESCRIPTION";
            public const string EIB_INTERFACE_DEV_NAME_XML = "EIB_INTERFACE_DEV_NAME";
            public const string EIB_INTERFACE_DEV_MAC_ADDRESS_XML = "EIB_INTERFACE_DEV_MAC_ADDRESS";
            public const string EIB_INTERFACE_DEV_MULTICAST_ADDRESS_XML = "EIB_INTERFACE_DEV_MULTICAST_ADDRESS";
            public const string EIB_INTERFACE_DEV_SUPPORTED_SERVICES_XML = "EIB_INTERFACE_DEV_SUPPORTED_SERVICES";
            public const string EIB_INTERFACE_DEV_SERIAL_NUMBER_XML = "EIB_INTERFACE_DEV_SERIAL_NUMBER";
            public const string EIB_INTERFACE_DEV_PHY_ADDRESS_XML = "EIB_INTERFACE_DEV_PHY_ADDRESS";
        }
        //bus monitor defs
